...
namespace ExportField_BL
{
    public class ExportFieldBL
    {
        public string ExportField_Select(ExportFieldsModel exportFieldsModel)
        {
            ...
            exportFieldsModel.Sqlprms[0] = new SqlParameter("@AutoID", exportFieldsModel.AutoID);
            exportFieldsModel.Sqlprms[1] = new SqlParameter("@ExportName", exportFieldsModel.ExportName);
            exportFieldsModel.Sqlprms[2] = new SqlParameter("@ExportValue", exportFieldsModel.ExportValue);
            exportFieldsModel.Sqlprms[3] = new SqlParameter("@ExportType", exportFieldsModel.ExportType);
            exportFieldsModel.Sqlprms[4] = new SqlParameter("@Status", exportFieldsModel.Status);
